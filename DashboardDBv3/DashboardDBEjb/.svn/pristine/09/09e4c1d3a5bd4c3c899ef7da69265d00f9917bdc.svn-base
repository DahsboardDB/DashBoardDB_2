...
public class Acuerdo {
	...
	private AcuerdoCuota acuerdoCuota;
	
	public Acuerdo(){
		acuerdoCuota =  new AcuerdoCuota();
	}
	...
	public AcuerdoCuota getAcuerdoCuota() {
		return acuerdoCuota;
	}
	public void setAcuerdoCuota(AcuerdoCuota acuerdoCuota) {
		this.acuerdoCuota = acuerdoCuota;
	}	
